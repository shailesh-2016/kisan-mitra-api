...
const CONTACT_EMAIL = 'legal@KisanPlus.app';
...
const UI_TEXTS: Record<string, any> = {
  en: {
    ...
    heroSub: 'Please read these terms carefully before using Kisan Plus. They govern your use of our app and services.',
    effective: 'Effective: ',
    updated: 'Updated: ',
    keyTitle: 'Key Points',
    keys: [
  ...
  hi: {
    ...
    heroSub: 'किसान प्लस का उपयोग करने से पहले कृपया इन शर्तों को ध्यान से पढ़ें। ये हमारे ऐप और सेवाओं के आपके उपयोग को नियंत्रित करते हैं।',
    effective: 'प्रभावी: ',
    updated: 'अपडेट: ',
  ...
  gu: {
    ...
    heroSub: 'કિસાન પ્લસનો ઉપયોગ કરતા પહેલા કૃપા કરીને આ શરતો ધ્યાનથી વાંચો. તે અમારી એપ્લિકેશન અને સેવાઓના તમારા ઉપયોગને સંચાલિત કરે છે.',
    effective: 'લાગુ: ',
    updated: 'અપડેટ: ',
  ...
  en: [
    {
      ...
      content: [
        { subtitle: 'Agreement', text: 'By downloading, installing, or using the Kisan Plus mobile application, you agree to be bound by these Terms and Conditions. If you do not agree to these terms, please do not use the app.' },
        { subtitle: 'Eligibility', text: 'You must be at least 18 years of age to use Kisan Plus. By using the app, you represent that you are 18 or older and have the legal capacity to enter into this agreement.' },
    ...
    },
    {
      ...
      content: [
        { subtitle: 'Permitted Use', text: 'Kisan Plus is designed for Indian farmers and agricultural workers to track farm activities, view mandi prices, check weather, and access government schemes. You may use the app for these lawful purposes.' },
        ...
        { subtitle: 'Account Responsibility', text: 'You are responsible for maintaining the security of your account. Your mobile number is your identity — do not share OTPs with anyone. Kisan Plus will never ask for your OTP via phone or message.' },
      ],
    },
    {
      ...
      content: [
        { subtitle: 'Your Data Ownership', text: 'All farm data you enter — machine records, profit calculations, reminders — belongs to you. Kisan Plus does not claim ownership of your personal farm data.' },
        { subtitle: 'Data Accuracy', text: 'You are responsible for the accuracy of data you enter. Kisan Plus is not liable for business decisions made based on data you have entered incorrectly.' },
    ...
    },
    {
      ...
      content: [
        ...
        { subtitle: 'Price Accuracy', text: 'We do not guarantee the accuracy, completeness, or timeliness of mandi price data. Kisan Plus is not liable for any financial loss resulting from reliance on prices shown in the app.' },
      ],
    },
    {
      ...
      content: [
        ...
        { subtitle: 'No Liability', text: 'Kisan Plus is not liable for crop damage, financial loss, or any other harm resulting from reliance on weather information provided in the app.' },
      ],
    },
    {
      ...
      content: [
        ...
        { subtitle: 'Official Sources', text: 'Always verify scheme details and apply through official government portals (pmkisan.gov.in, etc.) or your local Krishi Kendra. Kisan Plus is not an official government application.' },
        { subtitle: 'No Guarantee', text: 'We do not guarantee that you will receive any government benefit based on information shown in the app. Kisan Plus is not responsible for scheme application outcomes.' },
      ],
    },
    {
      ...
      content: [
        { subtitle: 'As-Is Service', text: 'Kisan Plus is provided "as is" without warranties of any kind. We do not guarantee uninterrupted service, error-free operation, or that the app will meet your specific requirements.' },
        { subtitle: 'Limitation of Liability', text: 'To the maximum extent permitted by Indian law, Kisan Plus and its developers shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of the app.' },
    ...
    },
    {
      ...
      title: 'Governing Law',
      content: [
        { subtitle: 'Jurisdiction', text: 'These Terms are governed by the laws of India. Any disputes arising from these terms or your use of Kisan Plus shall be subject to the exclusive jurisdiction of courts in Gujarat, India.' },
        { subtitle: 'Dispute Resolution', text: 'We encourage resolving disputes amicably. Please contact us at legal@KisanPlus.app before initiating any legal proceedings. We will make every effort to resolve issues within 30 days.' },
      ],
    },
    {
      ...
      title: 'Termination',
      content: [
        { subtitle: 'By You', text: 'You may stop using Kisan Plus at any time. You can delete your account from Settings → Delete Account, which will permanently remove all your data.' },
  ...
  hi: [
    {
      ...
      content: [
        { subtitle: 'समझौता', text: 'किसान प्लस मोबाइल एप्लिकेशन को डाउनलोड, इंस्टॉल या उपयोग करके, आप इन नियमों और शर्तों से बंधे होने के लिए सहमत हैं। यदि आप इन शर्तों से सहमत नहीं हैं, तो कृपया ऐप का उपयोग न करें।' },
        { subtitle: 'पात्रता', text: 'किसान प्लस का उपयोग करने के लिए आपकी आयु कम से कम 18 वर्ष होनी चाहिए। ऐप का उपयोग करके, आप यह दर्शाते हैं कि आप 18 वर्ष या उससे अधिक आयु के हैं और इस समझौते में प्रवेश करने की कानूनी क्षमता रखते हैं।' },
    ...
    },
    {
      ...
      title: 'ऐप का उपयोग',
      content: [
        { subtitle: 'अनुमत उपयोग', text: 'किसान प्लस को भारतीय किसानों और कृषि श्रमिकों के लिए खेती की गतिविधियों, मंडी की कीमतों, मौसम और सरकारी योजनाओं तक पहुंचने के लिए डिज़ाइन किया गया है। आप इन वैध उद्देश्यों के लिए ऐप का उपयोग कर सकते हैं।' },
        ...
        { subtitle: 'खाता जिम्मेदारी', text: 'आप अपने खाते की सुरक्षा बनाए रखने के लिए जिम्मेदार हैं। आपका मोबाइल नंबर आपकी पहचान है — किसी के साथ ओटीपी साझा न करें। किसान प्लस कभी भी फोन या संदेश के माध्यम से आपका ओटीपी नहीं मांगेगा।' },
      ],
    },
    {
      id: '3', icon: 'leaf-outline', iconColor: '#2E7D32', iconBg: '#E8F5E9',
      ...
      content: [
        { subtitle: 'आपका डेटा स्वामित्व', text: 'आपके द्वारा दर्ज किया गया सभी कृषि डेटा — मशीन रिकॉर्ड, लाभ की गणना, अनुस्मारक — आपका है। किसान प्लस आपके व्यक्तिगत कृषि डेटा पर स्वामित्व का दावा नहीं करता है।' },
        { subtitle: 'डेटा सटीकता', text: 'आप दर्ज किए गए डेटा की सटीकता के लिए जिम्मेदार हैं। किसान प्लस गलत तरीके से दर्ज किए गए डेटा के आधार पर लिए गए व्यावसायिक निर्णयों के लिए उत्तरदायी नहीं है।' },
    ...
    },
    {
      ...
      content: [
        ...
        { subtitle: 'मूल्य सटीकता', text: 'हम मंडी मूल्य डेटा की सटीकता, पूर्णता या समयबद्धता की गारंटी नहीं देते हैं। किसान प्लस ऐप में दिखाए गए मूल्यों पर निर्भरता के परिणामस्वरूप होने वाले किसी भी वित्तीय नुकसान के लिए उत्तरदायी नहीं है।' },
      ],
    },
    {
      id: '5', icon: 'partly-sunny-outline', iconColor: '#1565C0', iconBg: '#E3F2FD',
      ...
      content: [
        ...
        { subtitle: 'कोई देयता नहीं', text: 'किसान प्लस ऐप में दी गई मौसम की जानकारी पर निर्भरता के परिणामस्वरूप फसल के नुकसान, वित्तीय नुकसान या किसी अन्य नुकसान के लिए उत्तरदायी नहीं है।' },
      ],
    },
    {
      id: '6', icon: 'shield-outline', iconColor: '#7B1FA2', iconBg: '#F3E5F5',
      ...
      content: [
        ...
        { subtitle: 'आधिकारिक स्रोत', text: 'हमेशा योजना के विवरण को सत्यापित करें और आधिकारिक सरकारी पोर्टलों (pmkisan.gov.in, आदि) या अपने स्थानीय कृषि केंद्र के माध्यम से आवेदन करें। किसान प्लस आधिकारिक सरकारी एप्लिकेशन नहीं है।' },
        { subtitle: 'कोई गारंटी नहीं', text: 'हम इस बात की गारंटी नहीं देते हैं कि आपको ऐप में दिखाई गई जानकारी के आधार पर कोई भी सरकारी लाभ मिलेगा। किसान प्लस योजना आवेदन परिणामों के लिए ज़िम्मेदार नहीं है।' },
      ],
    },
    {
      id: '7', icon: 'alert-circle-outline', iconColor: '#C62828', iconBg: '#FFEBEE',
      ...
      content: [
        { subtitle: 'जैसा है सेवा', text: 'किसान प्लस किसी भी प्रकार की वारंटी के बिना "जैसा है" प्रदान किया जाता है। हम निर्बाध सेवा, त्रुटि मुक्त संचालन की गारंटी नहीं देते हैं, या कि ऐप आपकी विशिष्ट आवश्यकताओं को पूरा करेगा।' },
        { subtitle: 'देयता की सीमा', text: 'भारतीय कानून द्वारा अनुमत अधिकतम सीमा तक, किसान प्लस और इसके डेवलपर्स ऐप के आपके उपयोग से होने वाले किसी भी अप्रत्यक्ष, आकस्मिक, या परिणामी नुकसान के लिए उत्तरदायी नहीं होंगे।' },
    ...
    },
    {
      ...
      title: 'शासी कानून',
      content: [
        { subtitle: 'अधिकार क्षेत्र', text: 'ये शर्तें भारत के कानूनों द्वारा शासित होती हैं। इन शर्तों या किसान प्लस के आपके उपयोग से उत्पन्न होने वाले किसी भी विवाद गुजरात, भारत के न्यायालयों के अनन्य अधिकार क्षेत्र के अधीन होंगे।' },
        { subtitle: 'विवाद समाधान', text: 'हम सौहार्दपूर्ण ढंग से विवादों को सुलझाने के लिए प्रोत्साहित करते हैं। कृपया कोई भी कानूनी कार्यवाही शुरू करने से पहले legal@KisanPlus.app पर संपर्क करें। हम 30 दिनों के भीतर समस्याओं को हल करने का हर संभव प्रयास करेंगे।' },
      ],
    },
    {
      id: '9', icon: 'close-circle-outline', iconColor: '#C62828', iconBg: '#FFEBEE',
      title: 'समाप्ति',
      content: [
        { subtitle: 'आपके द्वारा', text: 'आप किसी भी समय किसान प्लस का उपयोग करना बंद कर सकते हैं। आप सेटिंग्स → खाता हटाएं से अपना खाता हटा सकते हैं, जो आपके सभी डेटा को स्थायी रूप से हटा देगा।' },
  ...
  gu: [
    {
      ...
      content: [
        { subtitle: 'કરાર', text: 'કિસાન પ્લસ મોબાઇલ એપ્લિકેશન ડાઉનલોડ કરીને, ઇન્સ્ટોલ કરીને અથવા ઉપયોગ કરીને, તમે આ નિયમો અને શરતોથી બંધાયેલા રહેવા માટે સંમત થાઓ છો. જો તમે આ શરતો સાથે સંમત નથી, તો કૃપા કરીને એપ્લિકેશનનો ઉપયોગ કરશો નહીં.' },
        { subtitle: 'પાત્રતા', text: 'કિસાન પ્લસનો ઉપયોગ કરવા માટે તમારી ઉંમર ઓછામાં ઓછી 18 વર્ષ હોવી જોઈએ. એપ્લિકેશનનો ઉપયોગ કરીને, તમે પ્રમાણિત કરો છો કે તમારી ઉંમર 18 વર્ષ કે તેથી વધુ છે અને આ કરારમાં પ્રવેશવાની કાનૂની ક્ષમતા ધરાવો છો.' },
    ...
    },
    {
      ...
      content: [
        { subtitle: 'માન્ય ઉપયોગ', text: 'કિસાન પ્લસ ભારતીય ખેડૂતો અને ખેતી કામદારો માટે ખેતીની પ્રવૃત્તિઓનું ધ્યાન રાખવા, મંડીના ભાવ જોવા, હવામાન ચકાસવા અને સરકારી યોજનાઓ મેળવવા માટે બનાવવામાં આવ્યું છે. તમે આ કાનૂની હેતુઓ માટે એપ્લિકેશનનો ઉપયોગ કરી શકો છો.' },
        ...
        { subtitle: 'એકાઉન્ટની જવાબદારી', text: 'તમે તમારા એકાઉન્ટની સુરક્ષા જાળવવા માટે જવાબદાર છો. તમારો મોબાઈલ નંબર તમારી ઓળખ છે — OTP કોઈની સાથે શેર કરશો નહીં. કિસાન પ્લસ ક્યારેય ફોન કે મેસેજ દ્વારા તમારો OTP માંગશે નહીં.' },
      ],
    },
    {
      id: '3', icon: 'leaf-outline', iconColor: '#2E7D32', iconBg: '#E8F5E9',
      ...
      content: [
        { subtitle: 'તમારો ડેટા માલિકી', text: 'તમે દાખલ કરો છો તે તમામ ખેતી ડેટા — મશીન રેકોર્ડ્સ, નફાની ગણતરી, રીમાઇન્ડર્સ — તમારો છે. કિસાન પ્લસ તમારા વ્યક્તિગત ખેતી ડેટાની માલિકીનો દાવો કરતું નથી.' },
        { subtitle: 'ડેટાની ચોકસાઈ', text: 'તમે દાખલ કરેલ ડેટાની ચોકસાઈ માટે તમે જવાબદાર છો. તમે ખોટી રીતે દાખલ કરેલ ડેટાના આધારે લીધેલા વ્યવસાયિક નિર્ણયો માટે કિસાન પ્લસ જવાબદાર નથી.' },
    ...
    },
    {
      ...
      content: [
        ...
        { subtitle: 'ભાવની ચોકસાઈ', text: 'અમે મંડીના ભાવ ડેટાની ચોકસાઈ, સંપૂર્ણતા અથવા સમયસરતાની બાંયધરી આપતા નથી. કિસાન પ્લસ એપ્લિકેશનમાં દર્શાવેલ ભાવ પર આધાર રાખીને થતા કોઈપણ નાણાકીય નુકસાન માટે જવાબદાર નથી.' },
      ],
    },
    {
      id: '5', icon: 'partly-sunny-outline', iconColor: '#1565C0', iconBg: '#E3F2FD',
      ...
      content: [
        ...
        { subtitle: 'કોઈ જવાબદારી નહીં', text: 'કિસાન પ્લસ એપ્લિકેશનમાં આપેલી હવામાનની માહિતી પર આધાર રાખીને પાકના નુકસાન, નાણાકીય નુકસાન અથવા અન્ય કોઈપણ નુકસાન માટે જવાબદાર નથી.' },
      ],
    },
    {
      id: '6', icon: 'shield-outline', iconColor: '#7B1FA2', iconBg: '#F3E5F5',
      ...
      content: [
        ...
        { subtitle: 'સત્તાવાર સ્ત્રોતો', text: 'હંમેશા યોજનાની વિગતો ચકાસો અને સત્તાવાર સરકારી પોર્ટલ (pmkisan.gov.in, વગેરે) અથવા તમારા સ્થાનિક કૃષિ કેન્દ્ર દ્વારા અરજી કરો. કિસાન પ્લસ અધિકૃત સરકારી એપ્લિકેશન નથી.' },
        { subtitle: 'કોઈ ગેરંટી નહીં', text: 'અમે બાંયધરી આપતા નથી કે તમને એપ્લિકેશનમાં દર્શાવેલ માહિતીના આધારે કોઈ સરકારી લાભ મળશે. કિસાન પ્લસ યોજનાની અરજીના પરિણામો માટે જવાબદાર નથી.' },
      ],
    },
    {
      id: '7', icon: 'alert-circle-outline', iconColor: '#C62828', iconBg: '#FFEBEE',
      ...
      content: [
        { subtitle: 'જેમ છે તેમ સેવા', text: 'કિસાન પ્લસ કોઈપણ પ્રકારની ગેરંટી વિના "જેમ છે તેમ" આપવામાં આવે છે. અમે વિક્ષેપ વિનાની સેવા, ભૂલ-મુક્ત કામગીરીની બાંયધરી આપતા નથી, અથવા એપ્લિકેશન તમારી ચોક્કસ નિશ્ચિત જરૂરિયાતોને પૂર્ણ કરશે તેવી બાંયધરી આપતા નથી.' },
        { subtitle: 'જવાબદારીની મર્યાદા', text: 'ભારતીય કાયદા દ્વારા માન્ય મહત્તમ મર્યાદા સુધી, કિસાન પ્લસ અને તેના વિકાસકર્તાઓ એપ્લિકેશનના તમારા ઉપયોગથી થતા કોઈપણ પરોક્ષ, આકસ્મિક અથવા પારિણામિક નુકસાન માટે જવાબદાર રહેશે નહીં.' },
    ...
    },
    {
      ...
      title: 'સંચાલિત કાયદો',
      content: [
        { subtitle: 'અધિકારક્ષેત્ર', text: 'આ નિયમો ભારતના કાયદા હેઠળ સંચાલિત થાય છે. આ શરતો અથવા કિસાન પ્લસના તમારા ઉપયોગથી ઉદ્ભવતા કોઈપણ વિવાદો ગુજરાત, ભારતના અદાલતોના વિશિષ્ટ અધિકારક્ષેત્રને આધીન રહેશે.' },
        { subtitle: 'વિવાદ નિરાકરણ', text: 'અમે મિત્રતાપૂર્ણ રીતે વિવાદોને ઉકેલવા પ્રોત્સાહિત કરીએ છીએ. કોઈપણ કાનૂની કાર્યવાહી શરૂ કરતા પહેલા કૃપા કરીને legal@KisanPlus.app પર અમારો સંપર્ક કરો. અમે ૩૦ દિવસમાં સમસ્યાઓને ઉકેલવા દરેક શક્ય પ્રયાસ કરીશું.' },
      ],
    },
    {
      id: '9', icon: 'close-circle-outline', iconColor: '#C62828', iconBg: '#FFEBEE',
      title: 'સમાપ્તિ',
      content: [
        { subtitle: 'તમારા દ્વારા', text: 'તમે કોઈપણ સમયે કિસાન પ્લસનો ઉપયોગ કરવાનું બંધ કરી શકો છો. તમે સેટિંગ્સ → એકાઉન્ટ કાઢી નાખો માંથી તમારું એકાઉન્ટ ભૂંસી શકો છો, જે તમારો તમામ ડેટા કાયમી ધોરણે રદ કરશે.' },
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.scroll}>
        ...
        >
          ...
          <Text style={s.heroSub}>
            Please read these terms carefully before using Kisan Plus. They govern your use of our app and services.
          </Text>
